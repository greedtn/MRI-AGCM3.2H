...
def compare(model_name):
    ...
    POT, CNT = func.plot(filename="csv/HFA_{}_c0.csv".format(model_name), img_title="HFA_{}_c0".format(model_name), output_name="png/pot/HFA_{}_c 0.png".format(model_name))
    POT_LEN = len(POT)
    ...
    POT_LEN = len(POT)
    RV_3 = func.lwm_gpd(data=POT, error=[0.005], thr=9.0, period=31, RP=100, n=CNT, n0=POT_LEN, con=0.95, img_name="png/param/HPA_{}_c3.png".format(model_name))
